<div x-show="hasPicked" class="fixed z-10 inset-0 overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom space-y-4 bg-white px-4 pt-5 pb-4 text-left overflow-hidden shadow border-2 border-black transform transition-all sm:my-8 sm:align-middle lg:max-w-4xl md:max-w-3xl sm:max-w-xl sm:w-full sm:p-6"
                        ...
                        <fieldset class="my-8 grid grid-cols-2">
                            ...
                            <div class="">
                                <div class="flex items-center mb-4">
                                    <input wire:model="picks.{{ $i }}.team_id" name="picks[$i][team_id]" type="radio"
