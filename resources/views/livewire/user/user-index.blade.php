                            ...
                            <div class="mt-1">
                                @if ($user->can('can pick 2021'))
                                    <span class="inline-flex items-center space-x-1 text-red-500 text-sm">
                                        ...
                                        <span class="text-gray-500">Needs to pick 2021 bowls</span> 
                                    </span>
                                @else
                                    <span class="inline-flex items-center space-x-1 text-green-500 text-sm">
                                        ...
                                        <span class="text-gray-500">Has picked 2021 bowls</span> 
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="-mt-px flex divide-x divide-gray-200">
                            <div class="w-0 flex-1 flex">
                                <a href="#"
                                    ...
                                    <!-- Heroicon name: mail -->
                                    {{-- <svg class="w-5 h-5 text-gray-400 flex-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
